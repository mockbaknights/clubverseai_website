...
export default function Hero5c() {
  return (
    <div className="flex flex-col items-center justify-center text-center space-y-8 px-4">
      ...
      <Link
        href="/contact"
        className="mt-8 px-8 py-4 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white rounded-full text-lg font-medium transition-all duration-200 shadow-lg shadow-amber-500/20 hover:shadow-amber-500/40"
      >
        Request Demo
      </Link>
    </div>
